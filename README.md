...
- **without-categories.md**&nbsp;— я пока не знаю, буду ли составлять новый список статей со своей разбивкой. Пока можно пользоваться [тем, который я составил](until-2023-01-17/without-categories.md) до изменения структуры категорий пользовательской документации на сайте «WordPress.org».
